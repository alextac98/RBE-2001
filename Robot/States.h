...
{
  Start = 0,
  robotStop = 1,          // This state will show up in every other state as an if() statement. if isStopped() == true, then store prev state and then switch, else doo other state.
  approachNuke = 2,
  pickUpNukeLow = 3,
  goToCenter = 4,
  findUsedDispenser = 5,
